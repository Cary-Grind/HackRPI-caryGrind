    ...
    methods: {
      loadGoogleMaps() {
        if (typeof window.google !== 'undefined') {
          ...
          script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyCF_zQA5quwiJ0Absat5w35Ly9Ch2H2MRw&libraries=places`;
          script.async = true;
          script.defer = true;
          script.onload = () => {
      ...
      async submitReview() {
        try {
          ...
          const response = await axios.post('https://129.161.129.165:8080/newreview', {
            ...this.newReview,
      ...
      async viewReviews(toilet) {
        try {
          const response = await axios.get('https://129.161.129.165:8080/seereview', {
